...
wget https://sourceforge.net/projects/opencvlibrary/files/4.1.2/opencv-4.1.2-android-sdk.zip
unzip opencv-4.1.2-android-sdk.zip
cd android/app/src/main
mkdir jniLibs
cp -r ./../../../../OpenCV-android-sdk/sdk/native/libs/ ./jniLibs
#cd ../../../../
#rm -rf opencv-4.1.2-android-sdk.zip
